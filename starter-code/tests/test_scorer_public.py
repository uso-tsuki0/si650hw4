...
from ranker import BM25, PivotedNormalization, TF_IDF, DirichletLM, WordCountCosineSimilarity, CrossEncoderScorer, PersonalizedBM25
...
class TestRankingMetrics(unittest.TestCase):
    ...
    def test_personalized_bm25_single_word_query(self):
        ...
        index_relevant = Indexer.create_index(
            IndexType.BasicInvertedIndex, 'data_relevant.jsonl', RegexTokenizer('\\w+'), set(), 0)        
